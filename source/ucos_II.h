...
/****
 * 为了节约不掉电的ram空间这里把uCos两个 消耗ram 的大数组放在了掉电ram中。
 * 注意在os_cfg。h里面配置好它们的地址。 --- 这两个宏
 * **/
#define		OSTCBTbl	((OS_TCB*)OSTCBTbl_BASEADDR)
#define		OSTCBPrioTbl	((OS_TCB**)OSTCBPrioTbl_BASEADDR)
